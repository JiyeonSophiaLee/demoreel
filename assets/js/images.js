...
function SetProperty(src,fileName,files,main,size,alt,skills=null,artstation=null,description=null){
  this.src = src;
...
const safer            = new SetProperty("/assets/images/projects/safer/"           , "safer_"           , ["01.jpg","02.jpg"]                                                       , 0 , {width:1920, height:1080}, "Freelance work for 3D safe"                                           , ['Maya','Arnold','Zbrush','Nuke']                                                                                                                                  , null                                      , saferDescrip());
...
const chandelier       = new SetProperty("/assets/images/projects/chandelier_scene/", "chandelier_scene_", ["01.jpg","02.jpg","03.jpg","04.jpg","05.jpg","06.jpg","07.jpg"]          , 0 , {width:1920, height:1080}, "3D rendering of chandelier for personal project"                      , ['Maya','Vray','Arnold','Zbrush','Substance Painder','Photoshop','3D Coat','Rezom UV','After Effects','Nuke']                                                      , 'https://www.artstation.com/artwork/Q2roZ', chandelierDescrip());
...
function saferDescrip(){
  return `This is 3~5 day’s work without rendering time.
  I did all the tastes from design, modeling, rigging, to post production.`
}
function chandelierDescrip(){
  return `I rendered Arnold and Vray for the same scene to see different refractions and reflections, then combined both rendering images to make the scene rich.
  The first and second shots are rendered in only one frame and use a 3D camera in Nuke to animate it.`
}